...
def foetel():
    kozos_eljarasok.csillagok("*", 40)#32 csillag fejléc
    ...
    if kerfoetelt=="I" or "i":
        kozos_eljarasok.rendeles_etel(f"{elso_foetel}", f"{elso}")
        kozos_eljarasok.rendeles_etel(f"{masodik_foetel}", f"{masodik}")
    kozos_eljarasok.csillagok("*", 40)  # 32 csillag fejléc
...
def leves():
    ...
    masodik:int=300
    if kerlevest=="I" or "i":
        kozos_eljarasok.rendeles_etel(f"{elso_leves}", f"{elso}")
        kozos_eljarasok.rendeles_etel(f"{masodik_leves}", f"{masodik}")
